			...
			>
				<View style={styles.textCode}>
					<TextInput
						...
						ref={inputRefOne}
						maxLength={1}
						onChangeText={(text) => handleChangCode(text, 1)}
					/>
				</View>
				<View style={styles.textCode}>
					<TextInput
						...
						ref={inputRefTwo}
						maxLength={1}
						onChangeText={(text) => handleChangCode(text, 2)}
					/>
				</View>
				<View style={styles.textCode}>
					<TextInput
						...
						ref={inputRefThree}
						maxLength={1}
						onChangeText={(text) => handleChangCode(text, 3)}
					/>
				</View>
				<View style={styles.textCode}>
					<TextInput
						...
						ref={inputRefFour}
						maxLength={1}
						onChangeText={(text) => handleChangCode(text, 4)}
					/>
				</View>
			</View>
