...
export const LibraryIcon = ({ width = 20, height = 20, color = 'white' }) => {
	return (
		<Svg
			dataEncoreId="icon"
			role="img"
...
export const HomeIcon = ({ width = 20, height = 20, color = 'white' }) => {
	return (
		<Svg
			dataEncoreId="icon"
			role="img"
...
export const SearchIcon = ({ width = 20, height = 20, color = 'white' }) => {
	return (
		<Svg
			dataEncoreId="icon"
			role="img"
...
export const PremiumIcon = ({ width = 20, height = 20, color = 'white' }) => {
	return (
		<Svg
			dataEncoreId="icon"
			role="img"
